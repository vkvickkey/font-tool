...
eelam = eelam.replace(/Bh/g, "க்ஷா");
eelam = eelam.replace(/iB/g, "க்ஷை");
eelam = eelam.replace(/ø/g, "க்ஷி");
eelam = eelam.replace(/ì/g, "க்ஷீ");
eelam = eelam.replace(/B&/g, "க்ஷு");
eelam = eelam.replace(/B\]/g, "க்ஷூ");
eelam = eelam.replace(/bB/g, "க்ஷெ");
eelam = eelam.replace(/nB/g, "க்ஷே");
eelam = eelam.replace(/bBh/g, "க்ஷொ");
eelam = eelam.replace(/nBh/g, "க்ஷோ");
eelam = eelam.replace(/bBs/g, "க்ஷௌ");
...
eelam = eelam.replace(/Í/g, "ஜி");
eelam = eelam.replace(/é/g, "ஜீ");
...
eelam = eelam.replace(/á/g, "சி");
eelam = eelam.replace(/Ó/g, "சீ");
eelam = eelam.replace(/R/g, "சு");
eelam = eelam.replace(/N/g, "சூ");
eelam = eelam.replace(/br/g, "செ");
eelam = eelam.replace(/nr/g, "சே");
eelam = eelam.replace(/ir/g, "சை");
eelam = eelam.replace(/¢/g, "ச்");
eelam = eelam.replace(/r/g, "ச");//////555
eelam = eelam.replace(/bPs/g, "ஞௌ");
eelam = eelam.replace(/nPh/g, "ஞோ");
eelam = eelam.replace(/bPh/g, "ஞொ");
eelam = eelam.replace(/Ph/g, "ஞா");
eelam = eelam.replace(/Á/g, "ஞி");
eelam = eelam.replace(/Ø/g, "ஞீ");
eelam = eelam.replace(/\|/g, "ஞு");
eelam = eelam.replace(/ú/g, "ஞூ");
eelam = eelam.replace(/bP/g, "ஞெ");
eelam = eelam.replace(/nP/g, "ஞே");
eelam = eelam.replace(/iP/g, "ஞை");
eelam = eelam.replace(/Š/g, "ஞ்");
eelam = eelam.replace(/P/g, "ஞ");//////555
...
eelam = eelam.replace(/Ã/g, "நி");
eelam = eelam.replace(/Ú/g, "நீ");
eelam = eelam.replace(/E/g, "நு");
eelam = eelam.replace(/ü/g, "நூ");
eelam = eelam.replace(/be/g, "நெ");
eelam = eelam.replace(/ne/g, "நே");
eelam = eelam.replace(/ie/g, "நை");
eelam = eelam.replace(/ª/g, "ந்");
eelam = eelam.replace(/e/g, "ந");//////555
...
eelam = eelam.replace(/œ/g, "ழ்");
eelam = eelam.replace(/H/g, "ழ");//////555
...
eelam = eelam.replace(/Ö/g, "றீ");
eelam = eelam.replace(/W/g, "று");
eelam = eelam.replace(/ù/g, "றூ");
eelam = eelam.replace(/bw/g, "றெ");
eelam = eelam.replace(/nw/g, "றே");
eelam = eelam.replace(/iw/g, "றை");
eelam = eelam.replace(/‰/g, "ற்");
eelam = eelam.replace(/w/g, "ற");//////555




eelam = eelam.replace(/bAs/g, "ஹௌ");
eelam = eelam.replace(/nAh/g, "ஹோ");
eelam = eelam.replace(/bAh/g, "ஹொ");
eelam = eelam.replace(/Ah/g, "ஹா");
eelam = eelam.replace(/Ï/g, "ஹி");
eelam = eelam.replace(/ë/g, "ஹீ");
eelam = eelam.replace(/A&/g, "ஹு");
eelam = eelam.replace(/A\]/g, "ஹூ");
eelam = eelam.replace(/bA/g, "ஹெ");
eelam = eelam.replace(/nA/g, "ஹே");
eelam = eelam.replace(/iA/g, "ஹை");
eelam = eelam.replace(/à/g, "ஹ்");
eelam = eelam.replace(/A/g, "ஹ");//////555

eelam = eelam.replace(/bõs/g, "ஷௌ");
eelam = eelam.replace(/nõh/g, "ஷோ");
eelam = eelam.replace(/bõh/g, "ஷொ");
eelam = eelam.replace(/õh/g, "ஷா");
eelam = eelam.replace(/Î/g, "ஷி");
eelam = eelam.replace(/ê/g, "ஷீ");
eelam = eelam.replace(/õ&/g, "ஷு");
eelam = eelam.replace(/õ]/g, "ஷூ");
eelam = eelam.replace(/bõ/g, "ஷெ");
eelam = eelam.replace(/nõ/g, "ஷே");
eelam = eelam.replace(/iõ/g, "ஷை");
eelam = eelam.replace(/Z/g, "ஷ்");
eelam = eelam.replace(/õ/g, "ஷ");//////555

eelam = eelam.replace(/b\[s/g, "ஸௌ");
eelam = eelam.replace(/n\[h/g, "ஸோ");
eelam = eelam.replace(/b\[h/g, "ஸொ");
eelam = eelam.replace(/\[h/g, "ஸா");
eelam = eelam.replace(/Ì/g, "ஸி");
eelam = eelam.replace(/è/g, "ஸீ");
...
eelam = eelam.replace(/Þ/g, "ஸ்");
eelam = eelam.replace(/\[/g, "ஸ");//////555

eelam = eelam.replace(/m/g, "அ");
eelam = eelam.replace(/M/g, "ஆ");
eelam = eelam.replace(/ï/g, "இ");
