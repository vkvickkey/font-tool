...
eelam = eelam.replace(/bQs/g, "ஹௌ");
eelam = eelam.replace(/nQh/g, "ஹோ");
eelam = eelam.replace(/bQh/g, "ஹொ");
eelam = eelam.replace(/Qh/g, "ஹா");
...
eelam = eelam.replace(/öås/g, "ஷௌ");
eelam = eelam.replace(/÷åh/g, "ஷோ");
eelam = eelam.replace(/öåh/g, "ஷொ");
eelam = eelam.replace(/åh/g, "ஷா");
