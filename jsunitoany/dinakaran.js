...
eelam = eelam.replace(/ஹௌ/g, "bQs");  
eelam = eelam.replace(/ஹோ/g, "nQh");  
eelam = eelam.replace(/ஹொ/g, "bQh");  
eelam = eelam.replace(/ஹா/g, "Qh");   
eelam = eelam.replace(/ஹி/g, "Qp");   
eelam = eelam.replace(/ஹீ/g, "QP");   
eelam = eelam.replace(/ஹு/g, "Q%");   
eelam = eelam.replace(/ஹூ/g, "Q\^");  
eelam = eelam.replace(/ஹெ/g, "bQ");   
eelam = eelam.replace(/ஹே/g, "nQ");   
eelam = eelam.replace(/ஹை/g, "iQ");   
eelam = eelam.replace(/ஹ்/g, "Q;");   
eelam = eelam.replace(/ஹ/g, "Q");    
